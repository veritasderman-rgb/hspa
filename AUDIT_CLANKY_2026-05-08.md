...
- **Hlavní zjištění auditu (verifikováno proti primárním zdrojům: Eurostat HLTH_PS_SCRTA dataset, Cervix.cz, NZIP, OECD Health at a Glance 2023, WHO publikace ISBN 9789240014107, health.gov.au, NHS UK gov.uk, Zákony pro lidi):**
  1. **Centrální cross-source variance v hodnotě CZ screeningu cervixu.** Dashboard HSPA Monitoru reportuje 52,3 % (NZIS / NRHZS metodika ÚZIS, screeningový vykázaný výkon). Eurostat za rok 2023 reportuje pro ČR <strong>74,7 %</strong> v programme-based administrative datasetu HLTH_PS_SCRTA (žen 20–69 s cytologií v posledních 3 letech, stejná core-definice). Rozdíl 22,4 procentního bodu vyplývá z užší vs. širší administrativní agregace — ÚZIS NZIS započítává jen vykázaný screeningový kód, zatímco Eurostat zahrnuje i cytologii vykázanou v rámci ročních preventivních gynekologických prohlídek (které v ČR fungují v paralelním režimu vedle formálního opt-in screeningu). Tato distinkce úplně mění narativ článku: v Eurostatových datech ČR patří mezi přední evropské země (Švédsko 77,7 %; Slovinsko 74,4 %; Finsko 73,0 %), nikoliv „pod evropskou špičku". Doplněn explicitní cross-source disclaimer s vysvětlením rozdílu a odkazem na obě metodiky.
