...
### 2026-05-12 · `clanek-alkohol-spotreba.html` — **kaskádový flag (alkohol + KV + preventovatelná mortalita)**
- **Status:** published → **flagged · review-pending** (centrální číslo článku 14,4 l/os. se z primárního zdroje OECD CHP 2025 neověřuje — CHP 2025 uvádí 11,2 l/os. pro ČR a 8,5 l/os. pro OECD průměr; současně článek opakuje již dříve flagged hodnoty KV mortality 220/140 a preventovatelné mortality 155/121).
- **Reviewer:** claude-code-agent
- **Priorita:** P2 (vysoké riziko věcné nepřesnosti — centrální číslo článku + tři kaskádové cross-referenced hodnoty z téže nesrovnalosti datového kontraktu vůči OECD H@G 2025 / CHP 2025, navazuje na kaskádové audity `clanek-kardiovaskularni-mortalita.html` 2026-05-11 a `clanek-pyll.html` 2026-05-11).
- **Co bylo špatně (verifikováno proti OECD Country Health Profile 2025 — Czechia, OECD Health at a Glance 2025, WHO Global Status Report on Alcohol and Health 2024, IARC Monographs Vol. 100E):**
  1. **Centrální číslo 14,4 l/os./rok pro ČR a 8,9 pro OECD průměr** — pochází z dashboardového indikátoru `alkohol_spotreba` (`data/indicators.json`, řez 2024 / 2026-05-05), nikoli přímo z OECD primárního zdroje. OECD CHP 2025 — Czechia uvádí pro ČR <strong>11,2 l/os.</strong> a pro OECD průměr <strong>8,5 l/os.</strong> (zaznamenaná spotřeba). Rozdíl pravděpodobně metodický (zaznamenaná vs. zaznamenaná + nezaznamenaná, referenční rok, kombinace prodejních statistik s populačními průzkumy) — část +62 % rezervy v dashboardu tedy vyplývá z metodického rozdílu, nikoli z reálné změny pití. Pozici ČR v <em>horní skupině zemí OECD</em> CHP 2025 nicméně potvrzuje (jedna z nejvyšších v rámci EU).
  2. **Kaskádové cross-referenced hodnoty:** kardiovaskulární mortalita 220 / 100 000 vs. OECD 140 — flagged kaskádově po auditu `clanek-kardiovaskularni-mortalita.html` (OECD H@G 2025: ČR cca 372 / 100k, 2023, ASR). Preventovatelná mortalita 155 / 100 000 vs. OECD 121 — flagged kaskádově po auditu `clanek-pyll.html` (OECD H@G 2025: ČR 142 / 100k, OECD průměr 145 / 100k — nikoli 121). Sebevražednost 12,5 / 100 000 vs. OECD 10,5 nebyla v rámci tohoto auditu samostatně přepočtena (poznamenáno jako otevřená otázka).
  3. **Derivované poměry závisí na flagged centrální hodnotě:** „zhruba o šedesát procent výš" v lead odstavci platí jen pro dashboardové hodnoty (14,4 / 8,9 ≈ +62 %); CHP 2025 hodnoty (11,2 / 8,5) odpovídají rozdílu cca +32 %. Stejně tak orientační „350 litrů 5% piva za rok = dvou velkých půllitrů denně" v sekci „Kolik je čtrnáct litrů" je derivováno z 14,4 a po rekonciliaci si vyžádá přepočet (mimo to: 14,4 l čistého alkoholu ÷ 0,05 = 288 l 5% piva, nikoli 350 — i derivace se zaslouží přepočet při republikaci).
  4. **Generický zdrojový URL `oecd.org/en/topics/health-statistics-and-data.html`** — bez stabilního permalinku k datasetu nebo publikaci; nahrazeno stabilním permalinkem `oecd.org/en/data/indicators/alcohol-consumption.html` + primárním permalinkem CHP 2025 a H@G 2025.
  5. **Generický `who.int/health-topics/noncommunicable-diseases` jako odkaz pro „Best Buys"** — Best Buys jsou specifická příloha (Appendix 3) Global Action Plan for the Prevention and Control of NCDs; nahrazeno permalinkem konkrétní publikace WHO (9789240091078).
  6. **Generický `iarc.who.int` (IARC Monographs landing page)** — alkohol je klasifikován v Monographs Vol. 100E (Personal Habits and Indoor Combustions, 2012); nahrazeno permalinkem konkrétního svazku.
  7. **Generický `szu.cz/`** — bez navigačního smyslu pro čtenáře; doplněno vysvětlující anchor (Systém monitorování zdravotního stavu obyvatelstva).
  8. **Chybějící WHO 2023 stanovisko „No level of alcohol consumption is safe"** — článek o tomto v textu mluví („žádná dávka alkoholu nesnižuje celkovou úmrtnost", odkaz na Lancet Public Health), ale stanovisko WHO/Europe z 4. ledna 2023 nebylo v sekci Zdroje uvedeno. Doplněno.
  9. **Chybějící primární zdroj k litevské reformě 2017** — text uvádí „Litva v roce 2017 zvedla spotřební daň…", ale bez konkrétní citace. Doplněn permalink na WHO/Europe case study (publikace 9789289054423).
- **Co bylo zachováno z původního článku (jádro článku zůstává v platnosti i po metodické rekonciliaci):**
  - Kvalitativní pozice ČR v horní skupině zemí OECD (CHP 2025 to potvrzuje, jen s mírně menším odstupem od průměru).
  - IARC Group 1 klasifikace alkoholu — verifikováno proti Monographs Vol. 100E.
  - WHO „Best Buys" rámec pro alkoholovou politiku — verifikováno proti Global Action Plan (zdanění a cena, dostupnost, reklama).
  - Skotská MUP 2018 a její evaluace — verifikováno proti Public Health Scotland evaluation portfolio.
  - Litevská reforma 2017 — verifikováno proti WHO/Europe case study.
  - Irská legislativa o zdravotním varování na obale — verifikováno (Public Health [Alcohol] Act 2018, regulations 2023 — povinná účinnost od 2026).
  - Orientační výpočty etanolu v nápojích (20 g / půllitr 5% piva, 19 g / 2 dl 12% vína, 13 g / panák 40% lihoviny) — verifikováno (50 ml × 0,789 × 0,40 = 15,8 g pro 4cl panák; rozsah orientace přijatelný).
  - Tři politické brzdy (sektorová lobby, rozpočtová úvaha, veřejné mínění) — kvalitativní argument zůstává; konkrétní procentuální nebo daňové údaje v této sekci nebyly tvrzeny, pouze rámcové.
- **Zdroje použité k revizi (všechny primární nebo institucionální):**
  - OECD — *Country Health Profile 2025 — Czechia* (sekce risk factors, alcohol consumption — ČR 11,2 l/os., OECD průměr 8,5 l/os.)
  - OECD — *Health at a Glance 2025* (kapitoly Alcohol consumption among adults; Mortality from circulatory diseases; Avoidable mortality)
  - OECD — Alcohol consumption indicator (datový explorer, řada `ALCOHOL` v `HEALTH_STAT`)
  ...
  - WHO — *Global Action Plan for the Prevention and Control of NCDs, Appendix 3 — Best Buys* (publikace 9789240091078)
  - WHO/Europe — Lithuania alcohol policy case study (publikace 9789289054423)
  - Public Health Scotland — MUP evaluation final report
  - IARC — Monographs Vol. 100E *Personal Habits and Indoor Combustions* (2012, klasifikace ethanol/alkoholické nápoje jako Group 1)
  - Interní: `clanek-kardiovaskularni-mortalita.html` (audit 2026-05-11), `clanek-pyll.html` (audit 2026-05-11) — kaskádový dohon
- **Otevřené otázky / topics pro budoucí iterace:**
  1. **Rekonciliace `alkohol_spotreba` v `data/indicators.json`** — společná otevřená otázka pro celý kaskádový cluster (alkohol-spotreba, pyll, koureni — denní kuřáctví 22,6 → 15,9). Doporučení: fixovat na OECD CHP 2025 / OECD Health Statistics (zaznamenaná spotřeba) nebo na WHO Global Status Report (zaznamenaná + nezaznamenaná, vyšší hodnoty) — v každém případě fixovat jednu metodiku napříč články a v metodické kartě ji explicitně uvést.
  2. **Přepočet derivovaných hodnot v textu** — po rekonciliaci centrální hodnoty přepočítat: „o šedesát procent výš" v leadu, „350 litrů pětiprocentního piva" v sekci „Kolik je čtrnáct litrů" (správně 288 l z 14,4; cca 224 l z 11,2), „dvou velkých půllitrů denně" (správně ~1,5 z 14,4; ~1,2 z 11,2).
  3. **Sebevražednost 12,5 / 100 000 vs. OECD 10,5** — samostatně neprověřeno proti OECD H@G 2025; pro budoucí kaskádu rozšíření auditu na `clanek-sebevrazdy-dusevni-zdravi.html`.
  4. **Vizuál: trend graf spotřeby alkoholu 2014–2024 (ČR vs. OECD vs. Litva vs. Skotsko)** — kandidát na liniový graf po rekonciliaci datového kontraktu; ukázal by efekt litevské reformy 2017 a skotské MUP 2018.
  5. **Vizuál: tabulka „Co dělají jiné země" (země | opatření | rok zavedení | měřitelný efekt | přenositelnost do ČR)** — již zmíněno v hlavní auditní zprávě (sekce 2.4); kandidát na strukturovanou srovnávací tabulku po rekonciliaci.
  6. **Doplnění českého kontextu Národní strategie pro prevenci a snižování škod spojených se závislostním chováním 2019–2027** (RVKPP / Úřad vlády) — chybí v sekci Zdroje a v textu; pro budoucí iteraci stojí za doplnění včetně reflexe jejího plnění.
- **Předtím / potom:** 1 centrální číslo flagged + opatřeno upřesněním proti CHP 2025 · 2 kaskádové cross-referenced hodnoty (KV mortalita, preventovatelná mortalita) flagged badge + cross-link na navazující audity · 1 ne-přepočtená hodnota (sebevraždy) explicitně označena · 1 review-pending audit banner v hlavičce přidán · 1 review-pending disclaimer v sekci Zdroje přidán · 1 meta-author audit line v hlavičce přidána · 5 generických zdrojových URL nahrazeno stabilními permalinky (OECD CHP 2025, OECD H@G 2025, OECD Alcohol indicator, WHO Best Buys 9789240091078, WHO/Europe Lithuania case study, IARC Mon. Vol. 100E, WHO 2023 statement) · 3 nové primární zdroje doplněny (CHP 2025, H@G 2025, WHO 2023 statement) · 2 nové policy zdroje doplněny (Best Buys Appendix 3, Lithuania case study) · 2 interní křížové odkazy na navazující kaskádové audity doplněny (kardiovaskularni-mortalita, pyll) · 0 textových odstavců smazáno · 0 nových vizuálů (kandidáty zaznamenány v otevřených otázkách — vázáno na rekonciliaci datového kontraktu).
