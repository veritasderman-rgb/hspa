...
### 2026-05-15 · `clanek-deficit-pojisteni-2026.html` — **kaskádová revize finančního clusteru po sourozeneckých draftech (status published → review-pending)**

- **Status:** published → **review-pending**. V `data/articles.json` `published: true → false` (po vzoru `clanek-deficit-vzp-2026.html` a `clanek-platba-statu-statni-pojistenci.html`), v hlavičce hospodářského brandbaru subtitul „Článek (DRAFT)" → „Článek (review-pending po auditu)". Republikace po ručním schválení redakce.
- **Priorita:** P1 (legislativní/finanční aktualita — článek se opírá o hodnotu platby státního pojištěnce 2026 a parametry zákona č. 48/1997 Sb. / 592/1992 Sb., které byly v sourozeneckých draftech opraveny 2026-05-11) + P2 (vysoké riziko věcné nepřesnosti — celá kalkulační infrastruktura článku stála na chybném počtu státních pojištěnců a chybné měsíční sazbě, což lineárně propisuje chybu i do tabulky politických nástrojů).
- **Trigger:** Závěr auditů `clanek-deficit-vzp-2026.html` a `clanek-platba-statu-statni-pojistenci.html` (oba 2026-05-11) explicitně doložil opravené hodnoty 2 188 Kč/měsíc × 5,9 mil. státních pojištěnců → ~155 mld. Kč/rok. Tento článek (publikovaný 8. 5. 2026, tj. před oběma audity sourozeneckých draftů) obsahoval starší chybnou paletu hodnot — 2 050 Kč/měsíc × ~4 mil. pojištěnců → ~166 mld. Kč/rok. Bez kaskádové revize by veřejně publikovaný portál uváděl tři protichůdné sady hodnot pro identickou rozpočtovou položku.
- **Co bylo špatně (verifikováno proti primárním zdrojům — VZP ZPP 2026 z 20. 10. 2025, MF ČR tiskové zprávy 2025, MZ ČR výsledky DŘ, OECD Health Statistics 2024, a křížové ověření se sourozeneckými audity):**
  1. **Platba státu za státního pojištěnce 2026: 2 050 Kč/měsíc.** Skutečnost: **2 188 Kč/měsíc** (vyměřovací základ 16 206 Kč × 13,5 %, nařízení vlády po jednání 30. 6. 2025). Zdroj: tiskové zprávy VZP ČR / ZP MV ČR / VoZP / MF ČR; ověřeno proti sourozeneckému auditu `clanek-platba-statu-statni-pojistenci.html` (2026-05-11). Opraveno v textu i v Tabulce 2.
  2. **Počet státních pojištěnců „zhruba čtyři miliony".** Skutečnost: **~5,9 milionu** (děti, důchodci, osoby na rodičovské, evidovaní uchazeči o zaměstnání a další kategorie dle § 7 zákona č. 48/1997 Sb.). Opraveno v textu. Křížově konzistentní s perexem sourozeneckého draftu (cit. „5,9 milionu lidí").
  3. **Roční výnos platby státu 2026: ~166 mld. Kč (30 % příjmů).** Skutečnost: **~155 mld. Kč (~28 % příjmů)** — odpovídá výpočtu 5,9 mil. × 2 188 Kč × 12 měsíců = ~154,9 mld. Kč a oficiální tiskové zprávě MF ČR 7/2025 („~154,6 mld. Kč"). Opraveno v Grafu 2 (Příjmy systému ~551 → ~540 mld. Kč; Platba státu ~166/30 % → ~155/28 %; pojistné zaměstnanci 67 % → 69 %).
  4. **Násobitel +100 Kč/měsíc = ~4,5 mld. Kč/rok.** Skutečnost: **~7,1 mld. Kč/rok** (5,9 mil. × 100 Kč × 12). Chyba je lineární propisí bodu 2: článek používal 4 mil. × 100 × 12 ≈ 4,8 mld. Opraveno v textu.
  5. **Tabulka politických nástrojů, řádek (b) „+500 Kč/měsíc → +25 mld. Kč".** Skutečnost: **~35 mld. Kč/rok** (5,9 mil. × 500 × 12 = 35,4 mld.). Opraveno v Tabulce 3.
  6. **Benchmark výdajů na zdravotnictví: „EU průměr 9,2 % HDP".** Skutečnost: **10,4 % HDP** (OECD Health Statistics 2024, datový kontrakt HSPA `vydaje_zdravotnictvi_hdp` > `benchmark.eu` = 10.4). OECD průměr 9,3 % zůstává správný. Opraveno v Grafu 4 a v jeho zdroji.
  7. **Dynamika výdajů „+6,4 % ročně".** Sourozenecký audit `clanek-deficit-vzp-2026.html` (2026-05-11) uvádí proti ZPP 2026 +7,1 %. Sjednoceno v leadu na +7,1 % (řádově +41 mld.) vs. příjmy +5,5 % (~+29 mld.) — odpovídá sourozeneckému draftu.
  8. **Šíře plánovaného deficitu „12–15 mld. dle MZ ČR / cca −20 mld. opozice / SZP".** Skutečnost dle ZPP a vyjádření SZP: **~12,7 mld. VZP samostatně / 12–19 mld. systém s nedoplatky**. Sjednoceno v leadu, v perexu, v `articles.json` perex a v Tabulce 1 (odhady deficitu).
- **Co bylo přepsáno / doplněno (s primárními zdroji):**
  - **Právní rámec platby státu** doplněn explicitně: § 3c zákona č. **592/1992 Sb.**, po novelizaci zákonem č. **260/2022 Sb.** (od roku 2024 valorizační vzorec „CPI + ½ růst reálných mezd" analogicky valorizaci důchodů — sjednoceno se sourozeneckým auditem, který explicitně vyvrátil mylné připisování formule konsolidačnímu balíčku 349/2023 Sb.).
  - **Rezervní fondy pojišťoven** doplněn právní rámec: § 7 odst. 4 zákona č. **551/1991 Sb.** (VZP), § 18 zákona č. **280/1992 Sb.** (SZP), § 11 zákona č. 280/1992 Sb. (ozdravný mechanismus).
  - **§ 7 zákona č. 48/1997 Sb.** doplněn jako právní vymezení „státního pojištěnce".
  - **EU zákaz amalgámu od 1. 1. 2025** doložen primárním právním aktem: nařízení EP a Rady (EU) **2017/852** o rtuti, čl. 10 odst. 2 (dříve článek používal pouze obecnou zmínku „zákaz zubního amalgámu platný od roku 2025").
  - **Úhradová vyhláška 432/2025 Sb.** propojena permalinkem na e-Sbírku (`https://e-sbirka.gov.cz/sb/2025/432/2026-01-01`) — sjednoceno s patternem auditovaného `clanek-uhradova-vyhlaska.html`.
  - **Interní křížové odkazy** doplněny do dvou sourozeneckých článků o financování: `clanek-deficit-vzp-2026.html` a `clanek-platba-statu-statni-pojistenci.html` (oba DRAFT, status `review-pending`); a do auditovaného `clanek-uhradova-vyhlaska.html`.
  - **`linked_indicators`** v `articles.json` opraveny: odstraněn duplikát `vydaje_zdravotnictvi_hdp` (byl uveden 2×) a doplněn dosud chybějící `hospitalizace_acsc` (článek na něj odkazuje v textu a v databoxu).
- **Co zůstává jako redakční flag (rezerva pojišťoven 47,7 → 41,7 mld. Kč):**
  - Číselné hodnoty „rezerv pojišťoven" v Grafu 1 (53,0 → 51,4 → 47,7 → 41,7 → 30,5 → 18,0 mld. Kč) jsou redakční sumarizace reportingu pojišťoven podzim 2025 a mediálních souhrnů. Sourozenecký draft `clanek-deficit-vzp-2026.html` (databox) uvádí pro **konec 2025** souhrn rezervních fondů **~32 mld. Kč** (VZP ~23 mld. + zaměstnanecké ~9 mld.) — to je významně méně než 47,7 mld. uvedených v původním grafu jako stav 2024.
  - Rozdíl pravděpodobně spočívá v **definici „rezerv"**: sourozenec mluví o `rezervní fond` (§ 7 odst. 4 z. 551/1991 Sb. / § 18 z. 280/1992 Sb.), v zákonném koridoru 1,5–3,0 % objemu úhrad. Původní článek pravděpodobně používá širší koncept zahrnující všechny mimorozpočtové fondy pojišťoven (rezervní + provozní + ostatní). Bez přístupu ke konsolidovaným ZPP všech 7 pojišťoven nelze tuto distinkci ověřit ani opravit v rámci tohoto auditu.
  - **Banner v hlavičce článku a poznámka v sekci Zdroje** transparentně toto označují („Stav rezerv pojišťoven 47,7 → 41,7 mld. Kč je orientační odhad reportingu pojišťoven podzim 2025 … před republikací doporučujeme zkontrolovat proti ZPP jednotlivých pojišťoven předkládaným Poslanecké sněmovně dle § 6 zákona č. 551/1991 Sb. a § 15 odst. 11 zákona č. 280/1992 Sb."). Audit hodnoty v grafu **neopravil ani nesmazal** — argumentační linka článku (eroze rezerv pod cash-flow minimum 1/12 výdajů) je robustní vůči konkrétním hodnotám.
- **Vizuální obohacení:** žádné nové grafy, mapy ani časové osy nepřidány. Existující vizuály (Graf 1 vývoj rezerv, Graf 2 příjmy/výdaje, Graf 3 navýšení úhrad, Graf 4 výdaje % HDP, Graf 5 OOP, Tabulka 1 odhady deficitu, Tabulka 2 strukturální síly, Tabulka 3 politické nástroje, Časová osa milníků 2026–2029) **byly opraveny věcně** (Graf 2, Graf 4, Tabulka 1, Tabulka 3), zdroje pod nimi byly přepsány s konkrétními primárními odkazy. Žádný nový datový bod nebyl přidán — všechny opravené hodnoty pocházejí z primárních zdrojů již ověřených v sourozeneckých auditech.
- **Sekce Zdroje** přepsána: ze 4 generických položek (mzcr.cz, vzp.cz, zdravotnickydenik.cz, e15.cz, zdravezpravy.cz, 2× zakonyprolidi.cz, oecd.org, eurohealthobservatory.who.int) na **18 stabilních primárních / institucionálních odkazů ve 4 kategoriích**: (1) Primární — pojišťovny, MZ ČR, MF ČR (4 položky); (2) Legislativa — e-Sbírka permalinky na 6 zákonů a 1 nařízení EU + 1 vyhláška (8 položek); (3) Mezinárodní srovnání — OECD Health Statistics + Health at a Glance + WHO Observatory (3 položky); (4) Sekundární zpravodajství explicitně odděleno a označeno (Zdravotnický deník, ČTK / finance.cz; 2 položky). Disclaimer v sekci Zdroje doplněn o cross-check s `vydaje_zdravotnictvi_hdp` a uvedení limitu odhadu rezerv.
- **Zdroje použité při ověření (všechny primární nebo institucionální):**
  - `clanek-deficit-vzp-2026.html` (řádky 7, 11, 49, 59, 66, 82–84, 92, 102, 120, 131, 135, 139, 145, 159, 189, 195, 205, 209, 213, 223, 227, 242, 248–249, 253, 265) — sourozenecký draft auditovaný 2026-05-11.
  - `clanek-platba-statu-statni-pojistenci.html` (meta description; perex; § 3c blok; historické hodnoty 2023–2026; tisková zpráva MF ČR 7/2025; § 260/2022 Sb. vs. 349/2023 Sb.; slovenská paralela) — sourozenecký draft auditovaný 2026-05-11.
  - `clanek-uhradova-vyhlaska.html` (banner pattern review-pending; permalink e-sbirka.gov.cz/sb/2025/432) — auditováno 2026-05-11.
  - `data/indicators.json` — `vydaje_zdravotnictvi_hdp` (value 8.5, benchmark.oecd 9.3, **benchmark.eu 10.4**, year 2024, SHA 2011), `platba_z_kapsy_pct` (value 14, year 2024), `hospitalizace_acsc` (value 580, year 2023).
  - VZP ČR — Zdravotně pojistný plán 2026 (schválen 20. 10. 2025; samostatný deficit −12,7 mld. Kč).
  - MF ČR — tisková zpráva 7/2025 k rozpočtu 2026 („~154,6 mld. Kč").
  - OECD Health Statistics 2024 (datový kontrakt HSPA `vydaje_zdravotnictvi_hdp` benchmark).
- **Otevřené otázky pro ruční rozhodnutí redakce / kandidáti na další iteraci:**
  1. **Rezervy pojišťoven 47,7 → 41,7 → 30,5 → 18,0 mld. Kč v Grafu 1 + Časové ose.** Před republikací článku doporučujeme nezávisle ověřit proti ZPP všech 7 pojišťoven 2026 a/nebo reportingu pojišťoven k Q1 2026, zda hodnoty odpovídají (a) konceptu „rezervní fond" v zákonném vymezení, (b) širšímu konceptu „mimorozpočtové fondy", nebo (c) celkovým zůstatkům účtů pojišťoven. Sourozenecký draft `clanek-deficit-vzp-2026.html` (databox) uvádí pro konec 2025 souhrn rezervních fondů ~32 mld. Kč, který je významně nižší než plán 41,7 mld. Kč pro konec 2026 v tomto článku — nelze obě hodnoty současně označit za „rezervy" bez explicitní definice.
  2. **Tempo růstu inovativních léčiv „+7–9 % nad inflací".** Bez primárního zdroje. Sourozenec uvádí „cenu centrově hrazených léčiv +11–14 % meziročně" (taktéž bez konkrétního zdroje, kandidát na samostatnou indikátorovou iteraci). Kandidát na vyžádání SÚKL HZD reportu nebo MZ ČR Akčního plánu pro CHL.
  3. **Demografická projekce „~30 000 osob/rok přechází z aktivního věku do důchodu".** Bez konkrétního ČSÚ zdroje. Kandidát na doplnění odkazu na ČSÚ *Projekce obyvatelstva ČR* (střední varianta) v navazující iteraci.
  4. **Cena CAR-T terapie „jednotky až nízké desítky milionů Kč/pacient".** Bez SÚKL HZD odkazu. Kandidát na doplnění v navazující iteraci proti SÚKL hodnotícím zprávám pro konkrétní CAR-T přípravky (Yescarta, Kymriah, Tecartus, Breyanzi, Carvykti, Abecma).
  5. **Sazba pojistného „13,5 % je v Česku neměnná od devadesátých let".** Faktická lhůta: 13,5 % zavedeno zákonem č. 592/1992 Sb. od roku 1993. Lze precizovat formulací „od roku 1993" namísto „od devadesátých let".
- **Předtím / potom:** 6 numerických chyb opraveno (platba 2 050 → 2 188 Kč; pojištěnci ~4 mil. → ~5,9 mil.; výnos 166/30 % → 155/28 %; násobitel +100 Kč 4,5 mld. → 7,1 mld.; tabulka 3 (b) +500 Kč 25 mld. → 35 mld.; EU benchmark výdajů 9,2 % → 10,4 % HDP) · dynamika výdajů sjednocena +6,4 % → +7,1 % (proti sourozeneckému ZPP 2026 rozboru) · šíře deficitu sjednocena 12–20 mld. → 12–19 mld. (po sourozeneckém SZP odhadu s nedoplatky) · 6 odstavců přepsáno s explicitními primárními zdroji (§ 3c z. 592/1992 Sb. po novele 260/2022 Sb.; § 7 z. 48/1997 Sb.; § 7 odst. 4 z. 551/1991 Sb. a § 18 z. 280/1992 Sb.; nařízení EU 2017/852 o rtuti; ÚV 432/2025 Sb. s permalinkem e-Sbírky; OECD Health Statistics 2024 s permalinkem) · 3 interní křížové odkazy doplněny (sourozenecký draft o deficitu VZP, sourozenecký draft o platbě státu, auditovaný `clanek-uhradova-vyhlaska.html`) · sekce Zdroje rozšířena z 9 generických položek ve 3 kategoriích na **18 stabilních primárních / institucionálních permalinků ve 4 kategoriích** (Primární — pojišťovny/ministerstva; Legislativa — e-Sbírka; Mezinárodní srovnání; Sekundární zpravodajství explicitně označeno) · 1 review-pending banner doplněn v hlavičce článku (konzistentní s patternem `clanek-uhradova-vyhlaska.html`, `clanek-koureni.html`, `clanek-reforma-pohotovosti-290-2025.html`, `clanek-mamograf-rakovina-prsu.html`) · 1 databox disclaimer přepsán s odkazem na § 3c z. 592/1992 Sb. po novele 260/2022 Sb. · `data/articles.json` aktualizováno: `published: true → false`, perex sjednocen s opravenou šíří deficitu, `linked_indicators` opraveny (odstraněn duplikát, doplněn `hospitalizace_acsc`) · hospodářský brandbar subtitul „DRAFT" → „review-pending po auditu" · 0 textových odstavců smazáno (vše transparentně opraveno nebo přepsáno) · 0 nových vizuálů (Graf 1 + Časová osa milníků s hodnotami rezerv ponechány s redakční flag pro nezávislé ověření) · 5 otevřených otázek pro ruční rozhodnutí redakce zaznamenáno.
