...
### 2026-05-12 · `clanek-alkohol-spotreba.html` — **kaskádová revize behaviorálního clusteru navazující na PYLL (alkohol → kardio → preventabilní mortalita → sebevraždy)**

- **Status:** published → **review-pending**. Článek je v kaskádovém řetězci flagovaných hodnot z auditu PYLL (2026-05-11): centrální datapoint článku `alkohol_spotreba` 14,4 l/os. ČR vs. 8,9 l/os. OECD je v PYLL audit-banneru explicitně označen jako neověřitelný proti OECD CHP 2025 (11,2 ČR vs. 8,5 OECD). Republikace po ručním schválení redakce a po sjednocení datového kontraktu.
- **Reviewer:** claude-code-agent
- **Priorita:** P2 (článek explicitně označen jako kaskádově dotčený předchozím PYLL auditem; centrální numerické claim 14,4 vs. 8,9 a kontextové odkazy na 220/140, 155/121, 12,5/10,5 byly bez auditní revize).
- **Trigger:** Audit `clanek-pyll.html` (2026-05-11), explicitně uvedená nesrovnalost: „spotřeba alkoholu (14,4 l/os. vs. 11,2 l/os. v CHP 2025)" + cascade-flag pro KV mortalitu, preventovatelnou mortalitu a sebevraždy.
- **Hlavní zjištění auditu (verifikováno proti primárním zdrojům: OECD/European Observatory CHP 2025 Czechia, OECD Health at a Glance 2025, IARC Monograph V100E 2012, IARC Handbooks V20A 2024, SZÚ NAUTA 2024, ČSÚ statistika alkoholických nápojů, WHO GSR 2024, Public Health Scotland MUP final evaluation 2023, Lancet GBD 2018 Griswold):**
  1. **Hodnota spotřeby alkoholu 14,4 l/os. ČR vs. 8,9 OECD — z primárního zdroje neověřuje.** OECD/European Observatory <em>Country Health Profile 2025 — Czechia</em> (s. 5, referenční rok 2023) uvádí pro ČR <strong>11,2 l/os. čistého alkoholu (15+)</strong> vs. OECD průměr <strong>8,5 l</strong> a řadí ČR na <strong>5. nejvyšší pozici v EU</strong> (ne první/druhé, jak text uvádí); cituje doslova „spotřeba od roku 2000 z větší části beze změny". Hodnota 14,4 l odpovídá řádově staršímu rámci (WHO recorded-only ~2010–2016) nebo jiné metodice (např. ČSÚ prodejní statistika alkoholických nápojů v litrech objemu, nikoli v litrech čistého etanolu). Datový kontrakt HSPA Monitoru vyžaduje rekonciliaci.
  2. **Cascade flag pro KV mortalitu 220/140** (stejný flag jako v kardio-clusteru) — doplněn inline badge `flagged` a křížový odkaz na audit `clanek-kardiovaskularni-mortalita.html`. Argumentační linie alkohol → vyšší KV zátěž zůstává robustní vůči konkrétní hodnotě.
  3. **Cascade flag pro preventovatelnou mortalitu 155/121** — CHP 2025 § 5.1 uvádí ČR preventovatelnou mortalitu pouze +16 % nad EU průměrem (treatable +26 %), založeno na Eurostat 2022. Konkrétní absolutní rates 155 ČR vs. 121 OECD se z primárního zdroje neověřují.
  4. **Cascade flag pro sebevražednost 12,5/10,5** — CHP 2025 reportuje pro ČR cca 11/100 000 a OECD průměr cca 11/100 000 — řádově parita, ne uvedené +19 %.
  5. **IARC klasifikace — zpřesnění citace.** Původní formulace „IARC klasifikuje alkohol jako karcinogen třídy 1 — stejnou kategorii jako tabák nebo azbest. Souvislost je doložena u rakoviny jater, jícnu, ústní dutiny a hltanu, kolorektálního karcinomu a u žen i u rakoviny prsu" — věcně správná, ale bez konkrétní citace. Doplněno: <strong>IARC Monographs Volume 100E: Personal Habits and Indoor Combustions — Consumption of Alcoholic Beverages</strong> (Lyon, 2012); první klasifikace ve Volume 44 (1988), potvrzena ve Volume 96 (2010); plný text na NCBI Bookshelf (<a href="https://www.ncbi.nlm.nih.gov/books/NBK304390/">NBK304390</a>). Cancer sites s „sufficient evidence in humans": dutina ústní, hltan, hrtan, jícen, játra, kolorektum, prs (ženy). Doplněna i <strong>IARC Handbooks of Cancer Prevention Volume 20A: Reduction or Cessation of Alcohol Consumption</strong> (2024) jako klíčový novější evidenční rámec.
  6. **Lancet 2018 — zpřesnění citace.** Původní „Studie publikované v posledních letech v <em>Lancetu</em> a v <em>Lancet Public Health</em> opakovaně ukázaly, že žádná dávka alkoholu nesnižuje celkovou úmrtnost" — bez konkrétní citace. Doplněno: <strong>Griswold MG et al., for the GBD 2016 Alcohol Collaborators. <em>Alcohol use and burden for 195 countries and territories, 1990–2016: a systematic analysis for the Global Burden of Disease Study 2016.</em> Lancet 2018;392:1015–1035, doi 10.1016/S0140-6736(18)31310-2</strong> — klíčová epidemiologická publikace pro tvrzení „žádná bezpečná dávka".
  7. **Skotsko MUP — zpřesnění data, ceny, finální evaluace.** Původní „Skotsko zavedlo v roce 2018 minimální cenu za jednotku alkoholu (Minimum Unit Pricing); evaluace publikované akademickou skupinou v Glasgow a v <em>Lancetu</em>" — bez přesných údajů. Doplněno: <strong>zavedeno 1. května 2018 na 50 p/jednotku (8 g čistého etanolu); v září 2024 navýšeno na 65 p</strong>. Finální evaluační report Public Health Scotland (Giles L et al., červen 2023) cit. s odkazem na publichealthscotland.scot.
  8. **Litva 2017 — zpřesnění legislativního rámce.** Původní „Litva v roce 2017 zvedla spotřební daň, omezila otevírací doby pro prodej alkoholu a zákonem zpřísnila reklamu" — neurčité datum účinnosti. Doplněno: <strong>Resolution XIII-545 přijatá v roce 2017, novela účinná od 1. ledna 2018: minimální věk pro prodej 20 let, prodejní doby 10:00–20:00 (po–so) a 10:00–15:00 (ne), zákaz reklamy</strong>. Pokles per-capita spotřeby (12,3 l 2016 → 11,2 l 2019, WHO HFA-DB) doložen explicitně.
  9. **Irsko etiketování — zpřesnění legislativního aktu.** Původní „Irsko přijalo legislativu vyžadující zdravotní varování přímo na obale alkoholických nápojů včetně textu o souvislosti s rakovinou" — bez přesné citace. Doplněno: <strong>Public Health (Alcohol) Act 2018, povinné zdravotní varování s účinností 22. května 2026</strong> (po tříletém přechodném období a notifikaci Evropské komise).
  10. **Metodika monitoringu — explicitní rozlišení tří metrik.** Doplněno upřesnění, že OECD/WHO (sales-based per-capita 15+), SZÚ NAUTA 2024 (self-report survey, ~7 l), a ČSÚ (objem prodaných alkoholických nápojů v litrech kapaliny — 2024: 156 l/obyv. celkem, z toho 130,5 l piva, 19,5 l vína, 6,1 l lihovin) nejsou přímo zaměnitelné.
  11. **Matematika „14,4 l = 350 litrů piva = 2 půllitry denně" — přepočet.** Původní text uvádí: „přibližně 350 litrů pětiprocentního piva … dvou velkých půllitrů denně". 14,4 l čistého alkoholu / 0,05 = 288 l piva (5 %), tedy ~0,79 l denně; 11,2 l / 0,05 = 224 l, tedy ~0,61 l denně. „350 l = 2 půllitry denně" implikuje 17,5 l čistého alkoholu, což neodpovídá ani dashboard hodnotě 14,4. Přepracováno na věcné rozpětí s konkrétním přepočtem pro obě hodnoty.
  12. **Sekce Zdroje rozšířena z 8 generických URL na 16 stabilních primárních / institucionálních / DOI permalinků ve 3 kategoriích** (Data — primární zdroje 9 položek včetně OECD CHP 2025 PDF a Eurostat datasetů; Evidence — karcinogenita a populační dopad 5 položek včetně IARC V100E NCBI Bookshelf, IARC V20A 2024, Lancet 2018 DOI, IHME GBD profile; Policy inspirace 4 položky včetně WHO SAFER, Public Health Scotland MUP final, Lithuania Law on Alcohol Control, Irish Public Health Alcohol Act 2018).
- **Co bylo přepracováno:**
  - **Banner v hlavičce** (nový) — status review-pending, kaskádový flag, výčet hlavních zjištění, odkaz na audity PYLL a kardio-clusteru.
  - **Meta robots** z `index, follow` na `noindex, follow` + nový `<meta name="article:audit-status" content="review-pending">`.
  - **Meta description a og:description** — přepsány na korektní formulaci s CHP 2025 hodnotami.
  - **Deck** — doplněn flagged badge u 14,4 i 8,9 a explicitní vysvětlení CHP 2025 hodnoty 11,2/8,5 a 5. nejvyšší pozice v EU.
  - **Sekce „Kolik je čtrnáct litrů"** přejmenována na „Kolik je jedenáct (či čtrnáct) litrů"; přepočet piva korigován pro obě hodnoty; metodika OECD/WHO vs. SZÚ NAUTA vs. ČSÚ explicitně rozlišena.
  - **Sekce „Co alkohol dělá zdraví"** — IARC citace přepsána s explicitním Vol. 100E (2012), doplněn IARC Vol. 20A (2024); Lancet 2018 (Griswold GBD) doplněn s DOI; cluster flag pro KV/preventabilní/sebevraždy v inline formě.
  - **Sekce „Co funguje v zemích…"** — Skotsko MUP s daty/cenou/evaluací; Litva XIII-545 s 2018-01-01 účinností a konkrétními parametry; Irsko Public Health Act 2018 s 22. května 2026 účinností.
  - **Lead a poslední odstavec** — přepsány na CHP 2025 hodnotu 11,2 l/os. (původní 14,4 ponechán ve flagged formě v deck/databoxu pro auditovatelnost).
  - **Databox** — všechny 4 indikátory doplněny flagged badge a explicitními rozdíly proti CHP 2025; disclaimer rozšířen o IARC/Lancet citaci a tři monitorovací metodiky.
  - **Sekce Zdroje** — kompletně přepracována ze 3 kategorií / 8 URL na 3 kategorie / 16 permalinků s explicitní fetch-datum poznámkou.
  - **Sekce-disclaimer** — výrazně rozšířen o explicitní popis rekonciliace datového kontraktu a tří monitorovacích metodik.
- **Co bylo zachováno bez úprav (ověřeno):**
  - Centrální argumentační struktura článku — vyšší spotřeba ČR, slabá národní politika, mezinárodní nástroje s evidencí, tři politické brzdy (síla sektorů, rozpočet, veřejné mínění).
  - Cenová elasticita alkoholu (~−0,5 % spotřeby na +1 % ceny) — řádově odpovídá meta-analýzám (Wagenaar et al. Addiction 2009; Elder et al. Am J Prev Med 2010).
  - Doporučení WHO pro individuální spotřebu (≤20 g etanolu denně u mužů, ≤10 g u žen, alespoň 2 dny bez alkoholu týdně) — řádově konzistentní s NZIP a WHO orientačními limity.
  - Přepočet etanolu v nápojích (půllitr 5% piva ≈ 20 g; 2 dcl 12% vína ≈ 19 g; panák 40% lihoviny ≈ 13 g) — odpovídá NZIP a NIAAA standard drink calculator.
- **Zdroje použité k revizi (všechny primární nebo institucionální):**
  - OECD/European Observatory on Health Systems and Policies. *State of Health in the EU — Country Health Profile 2025: Czechia.* PDF: oecd.org/content/dam/oecd/en/publications/reports/2025/12/country-health-profile-2025-country-notes_7e72146d/czechia_e16c6d2d/7d087e31-en.pdf
  - OECD. *Health at a Glance 2025* — Paris, listopad 2025.
  - OECD Data Explorer — Alcohol consumption indicator.
  - IARC. *Monographs Volume 100E: Personal Habits and Indoor Combustions* (2012); NCBI Bookshelf NBK304390. První klasifikace Vol. 44 (1988), potvrzeno Vol. 96 (2010).
  - IARC. *Handbooks of Cancer Prevention Volume 20A: Reduction or Cessation of Alcohol Consumption* (2024).
  - Griswold MG et al. *Alcohol use and burden for 195 countries and territories, 1990–2016: a systematic analysis for the GBD Study 2016.* Lancet 2018;392:1015–1035. DOI 10.1016/S0140-6736(18)31310-2.
  - WHO. *Global Status Report on Alcohol and Health and Treatment of Substance Use Disorders 2024* (Geneva, 25. června 2024).
  - WHO Europe. *European Health for All Database* (HFA-DB); *Alcohol Country Fact Sheet — Czechia 2019*.
  - SZÚ. *Národní výzkum užívání tabáku a alkoholu v České republice 2024 (NAUTA)*.
  - ČSÚ. *Spotřeba alkoholických nápojů na 1 obyvatele v České republice* — 2024 stav (156 l celkem; 130,5/19,5/6,1 l pivo/víno/lihoviny).
  - Eurostat — datasets hlth_sa_consum, sdg_03_50, hlth_cd_apr.
  - Public Health Scotland. *Evaluating the impact of Minimum Unit Pricing (MUP) in Scotland — Final Report* (Giles L et al., červen 2023).
  - Government of Lithuania. *Law on Alcohol Control, Resolution XIII-545* (2017, účinnost 1. ledna 2018).
  - Government of Ireland. *Public Health (Alcohol) Act 2018* — Irish Statute Book.
  - WHO. *SAFER Initiative — five high-impact interventions for alcohol control*.
- **Otevřené otázky pro ruční rozhodnutí redakce / kandidáti na další iteraci:**
  1. **Rekonciliace `alkohol_spotreba` v `data/indicators.json`** — doporučení: aktualizovat hodnotu na OECD CHP 2025 (11,2 ČR / 8,5 OECD, 2023) nebo přejít na OECD Data Explorer `DSD_HEALTH_LVNG@DF_HEALTH_LVNG_AC` jako primární zdroj; v každém případě fixovat jeden zdroj a aktualizovat seed hodnotu, trend řadu i article perex / og description.
  2. **Rekonciliace `mortalita_kardiovaskularni`, `mortalita_preventabilni`, `sebevrazdy_per_100k`** — společný cascade-cluster s článkem o kardiovaskulárním paradoxu, PYLL a iktových centrech (čtyřčlánkový cluster).
  3. **Vizuál: časová řada spotřeby alkoholu ČR vs. OECD průměr (2000–2023)** — CHP 2025 explicitně cituje „od roku 2000 z větší části beze změny"; kandidát na liniový graf s OECD Data Explorer časovou řadou (po validaci hodnot z primárního zdroje).
  4. **Vizuál: srovnávací tabulka „Co dělají jiné země"** — Skotsko (MUP 2018), Litva (XIII-545 2017), Irsko (Public Health Alcohol Act 2018), Norsko/Švédsko/Finsko (státní monopol), Francie (Loi Évin 1991, restrikce reklamy) — kandidát na strukturovaný přehled (země / opatření / rok účinnosti / měřitelný efekt / přenositelnost).
  5. **Doplnění SZÚ NAUTA 2024 sebehodnocených ukazatelů** — rizikové pití podle AUDIT-C, prevalence nadužívání, gender/age distribuce — kandidát na detailnější rozpad v samostatném sub-článku nebo jako rozšířený databox.
  6. **Vizuál: rozpad spotřeby ČR podle druhu nápoje (pivo / víno / lihoviny)** — ČSÚ má dlouhodobá data v litrech objemu (2024: 130,5 / 19,5 / 6,1 l); kandidát na sloupcový/stacked graf po normalizaci na ekvivalent čistého etanolu (orientačně: pivo 5 % → 0,05 l etanolu/l; víno 12 % → 0,12 l/l; lihovina 40 % → 0,40 l/l).
- **Předtím / potom:** 4 kaskádové výskyty hodnot dashboardu (14,4 alkohol / 220 KV / 155 prevent / 12,5 suicid) doplněny flagged badge a inline cross-link · 1 review-pending banner v hlavičce přidán · meta robots z `index, follow` na `noindex, follow` + `article:audit-status: review-pending` · meta description / og:description přepsány na CHP 2025 hodnoty · sekce „Kolik je čtrnáct litrů" přejmenována a doplněna o korektní přepočet piva pro obě hodnoty · IARC citace upřesněna na Vol. 100E (2012) + Vol. 20A (2024) s cancer sites · Lancet 2018 (Griswold GBD) doplněn s DOI · Skotsko MUP zpřesněno (1. května 2018, 50 p → 65 p v září 2024, Public Health Scotland final evaluation 2023) · Litva Resolution XIII-545 (2017, účinnost 2018-01-01) s konkrétními parametry (věk 20, prodejní doby, reklama) · Irsko Public Health (Alcohol) Act 2018 s datem účinnosti varování (22. května 2026) · tři monitorovací metodiky (OECD/WHO sales-based, SZÚ NAUTA self-report, ČSÚ objem) explicitně rozlišeny · 8 generických zdrojových URL nahrazeno 16 stabilními permalinky ve 3 kategoriích · `articles.json` aktualizován s audit objektem (`cascade_flags`, `primary_sources_added: 12`, `notes`) · 0 textových odstavců smazáno · 0 nových vizuálů (kandidáty zaznamenány v otevřených otázkách).
