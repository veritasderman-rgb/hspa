...
### 2026-05-12 · `clanek-alkohol-spotreba.html` — **kaskádový flag centrálního čísla (WHO total APC vs. OECD recorded) + revize WHO/Skotsko/Litva/Irsko**

- **Status:** published → **review-pending**. Republikace po ručním schválení redakce a po rekonciliaci indikátoru `alkohol_spotreba` v datovém kontraktu HSPA.
- **Reviewer:** claude-code-agent
- **Priorita:** P2 (sourozenec právě auditovaného `clanek-koureni.html` v životním stylu cluster · centrální numerické claim 14,4 vs. OECD 8,9 dosud neauditováno · KV cascade flag z předchozí kardio-clusterové iterace nutno propsat).
- **Trigger:** Audit `clanek-koureni.html` (2026-05-11) — analogická revize jiného rizikového faktoru životního stylu. Souběžně otevřená rekonciliace KV mortality 220/140 z kardio-clusteru.
- **Hlavní zjištění auditu (verifikováno proti primárním zdrojům: OECD <em>Health at a Glance 2025</em>, kapitola Alcohol consumption; WHO GISAH a Global Status Report on Alcohol and Health 2018; WHO Europe 2023 stanovisko „No level of alcohol consumption is safe" + Anderson et al. <em>Lancet Public Health</em> 2023; Rumgay et al. <em>NEJM</em> 2023 IARC perspective; IARC Monographs Vol 100E (2012); Wagenaar et al. <em>Addiction</em> 2009; Wyper et al. <em>Lancet</em> 2023 MUP evaluace; Štelemėkas et al. <em>BMC Medicine</em> 2022 a Rehm et al. <em>Addiction</em> 2025 pro Litvu; Public Health (Alcohol) Act 2018 + S.I. 249/2023 + S.I. 422/2025 a S.I. 423/2025 pro Irsko):**
  1. **Centrální číslo „14,4 l" — cascade flag, nikoli oprava.** Hodnota odpovídá <em>WHO GISAH total APC</em> (recorded + unrecorded, data ~2016, Global Status Report 2018). OECD <em>Health at a Glance 2025</em> publikované v 11/2025 uvádí pro ČR <strong>11,2 l/os./rok</strong> (recorded only, 2023) proti průměru OECD <strong>8,5 l</strong> (ne 8,9). Rozdíl je metodický (unrecorded vrstva, kterou OECD nezachycuje) i časový. Indikátor `alkohol_spotreba` v datovém kontraktu HSPA Monitoru je předmětem otevřené rekonciliace; argumentační logika článku (ČR mezi nejvyššími v OECD, žádný z osvědčených nástrojů nezaveden) zůstává robustní v obou metodikách (ČR je v obou v top pětici a 30–60 % nad průměrem). Místo silentní opravy zaveden cascade flag analogický KV mortalitě: badge „flagged" v databoxu, metodická poznámka v leadu i v databox-disclaimeru, review-pending banner v hlavičce.
  2. **KV mortalita 220/140 — propsání cascade flagu z kardio-clusteru.** Stejný flag jako v `clanek-kardiovaskularni-mortalita.html`, `clanek-akutni-infarkt.html` a `clanek-cmp-iktova-centra.html`. Hodnota zachována v databoxu i v textu, doplněn flagged badge a cross-link.
  3. **WHO 20 g / 10 g denního etanolu — falešná atribuce.** Původní text „WHO doporučuje pro zdravé dospělé muže nepřekračovat 20 gramů etanolu denně, pro ženy 10 — a alespoň dva dny v týdnu být zcela bez alkoholu" je faktická chyba: <strong>WHO takovou kvantitativní hranici nevydává</strong>. Hodnoty 10–20 g jsou historicky z národních doporučení (britské NHS, německé BZgA, Společnost pro návykové nemoci ČLS JEP). WHO ve svém oficiálním stanovisku z ledna 2023 (Lancet Public Health) explicitně uvádí, že <em>neexistuje úroveň spotřeby alkoholu, která by neměla vliv na zdraví</em>, a kvantitativní bezpečnou hranici stanovit nelze. Přepsáno se správnou atribucí národním doporučením + zvýrazněno WHO stanovisko 2023.
  4. **Skotská MUP vs. daňový argument — věcná nepřesnost.** Původní formulace „Skotský i litevský případ tuto úvahu potvrzují" v sekci o vyšších daňových příjmech po reformě je zavádějící: <strong>skotská MUP není daň</strong>, dodatečná marže zůstává obchodníkům a výrobcům, takže státní rozpočet z ní přímo nečerpá. Daňový argument se vztahuje pouze na případ Litvy. Přepsáno s explicitním rozlišením a doplněním návratnosti investice z Rehm 2025 (~420 € na 1 € investovaný).
  5. **Litevská reforma — 2017 → balíček 2017–2018.** Původně „Litva v roce 2017 zvedla spotřební daň, omezila otevírací doby pro prodej alkoholu a zákonem zpřísnila reklamu" — komplexní zákaz reklamy v EU byl Litvou zaveden až 2018. Upřesněno na „reformní balíček 2017–2018" s konkrétními procentními daňovými skoky (23 % lihoviny / 92–111 % víno / 112 % pivo), otevíracími hodinami (pracovní dny 10–20 h, neděle do 15 h), zvýšení věkového limitu na 20 let a doplněn ad-ban 2018.
  6. **Přepočet ekvivalentu piva — vnitřní inkonzistence.** Původně „přibližně 350 litrů pětiprocentního piva — tedy zhruba dvou velkých půllitrů denně" — pětiprocentní pivo (5 % ABV) by dávalo 14,4 / 0,05 = 288 L, ne 350. Vnitřně inkonzistentní o ~20 %. Opraveno na „přibližně 360 L čtyřprocentního výčepního piva (10° desítka)" — odpovídá necelému jednomu velkému půllitru denně. Doplněna paralelní hodnota pro OECD H@G 2025 (11,2 l = 280 L piva).
  7. **Irsko — labellingový režim s posunutím účinnosti.** Původní text „Irsko přijalo legislativu vyžadující zdravotní varování přímo na obale alkoholických nápojů včetně textu o souvislosti s rakovinou" je faktický, ale neúplný. Doplněno: Public Health (Alcohol) Act 2018, § 12; prováděcí předpis S.I. 249/2023 (původní účinnost 22. 5. 2026); S.I. 422/2025 a S.I. 423/2025 z 07/2025 odsunují účinnost na <strong>3. 9. 2028</strong>. Doplněn akademický komentář z <em>Lancet Regional Health – Europe</em> 2025.
  8. **Vědecká shoda o riziku — IARC + meta-analýza Zhao 2023.** Doplněna explicitní citace IARC Monographs Vol 100E (2012) s permalinkem na publications.iarc.fr, sedm typů rakoviny (ústní dutina, hltan, hrtan, jícen, játra, kolorektum, prs u žen). Doplněna citace Rumgay et al. NEJM 2023 IARC perspective a Anderson et al. Lancet Public Health 2023. Vyjasnění J-křivky úmrtnosti jako metodického artefaktu (zařazení bývalých pijáků mezi „abstinenty").
  9. **Cenová elasticita — primární citace Wagenaar 2009.** Doplněna meta-analýza Wagenaar, Salois & Komro (Addiction 2009, DOI 10.1111/j.1360-0443.2008.02438.x, PMID 19149811) s konkrétními elasticitami pro pivo (−0,46), víno (−0,69), lihoviny (−0,80) a heavy drinking (−0,28).
  10. **Sekce Zdroje — rozšíření ze 7 generických URL na 20 stabilních permalinků s DOI ve 4 kategoriích** (Data spotřeby, Klinická a epidemiologická evidence, Policy inspirace Skotsko/Litva/Irsko, Metodika a institucionální rámec ČR). Doplněn audit-disclaimer s cascade flagem APC i KV mortality.
- **Co bylo přepracováno:**
  - **Banner v hlavičce** (nový) — status review-pending, cascade flag APC i KV, popis hlavních úprav, dvojitý cascade flag (APC + KV).
  - **Article-lead** — kvantitativní framing přepracován z „o šedesát procent výš" na duální metodiku (WHO 14,4 / OECD 11,2) s explicitním uvedením obou primárních zdrojů a permalinky.
  - **Sekce „Kolik je čtrnáct litrů"** — opraven přepočet piva (5 % → 4 %/10° desítka, 350 → 360 L) s paralelním přepočtem pro 11,2 l. Posílena metodická poznámka (WHO total APC vs. OECD recorded, časový rozdíl 2016 vs. 2023).
  - **Sekce „Co alkohol dělá zdraví"** — odstavec s vědeckou shodou přepsán: explicitní IARC Vol 100E citace, sedm typů rakoviny, WHO 2023 stanovisko, Zhao 2023 vysvětlení artefaktu J-křivky. Druhý odstavec doplněn flagged badge pro KV + interní cross-linky na koureni a pm25. Třetí odstavec přepracován pro správnou atribuci 10–20 g (národní doporučení, ne WHO) + zvýraznění WHO 2023 stanoviska.
  - **Sekce „Co funguje v zemích, které spotřebu skutečně snížily"** — všechny tři odstavce přepsány: Wagenaar 2009 elasticity, Wyper 2023 MUP evaluace s DOI a procentními poklesy (13,4 % úmrtí, 4,1 % hospitalizací), Štelemėkas 2022 + Rehm 2025 pro Litvu s konkrétními procentními skoky, korigovaná chronologie ad-banu 2018, Irsko s S.I. 249/2023 a odložením na 2028.
  - **Sekce „Tři politické brzdy"** — druhý odstavec o rozpočtové úvaze přepsán s rozlišením daň vs. minimální cena (Litva potvrzuje, Skotsko ne — výnos jde obchodníkům).
  - **Sekce „Co s tím"** — první odstavec přepsán s korektní atribucí 10–20 g národním doporučením + WHO 2023 stanovisko. Druhý odstavec přepsán s explicitní paralelou WHO 14,4 vs. OECD 11,2.
  - **Databox** — flagged badge na alkohol_spotreba (s metodickou poznámkou WHO vs. OECD) i na mortalita_kardiovaskularni (s cross-linkem na kardio audit). Databox-disclaimer výrazně rozšířen o metodickou poznámku a cross-linky na koureni a pm25.
  - **Sekce Zdroje** — kompletně přepracována, ze 7 generických URL na 20 stabilních permalinků s DOI ve 4 kategoriích. Doplněn audit-disclaimer s cascade flagem APC i KV mortality + technická poznámka o ABV českých piv.
- **Co bylo doplněno (klíčové primární zdroje):**
  - OECD H@G 2025 kapitola Alcohol consumption (přímý permalink na _f009f222.html).
  - WHO 2023 stanovisko + Anderson et al. Lancet Public Health 2023 (DOI 10.1016/S2468-2667(22)00317-6).
  - Rumgay et al. NEJM 2023 IARC perspective.
  - IARC Monographs Vol 100E (Personal Habits & Indoor Combustions, 2012, publications.iarc.fr).
  - Wagenaar, Salois & Komro Addiction 2009 (DOI 10.1111/j.1360-0443.2008.02438.x).
  - Wyper et al. Lancet 2023 MUP evaluace (DOI 10.1016/S0140-6736(23)00497-X, PMID 36963415).
  - Štelemėkas et al. BMC Medicine 2022 (DOI 10.1186/s12916-022-02721-6).
  - Rehm et al. Addiction 2025 (DOI 10.1111/add.70083).
  - Public Health (Alcohol) Act 2018 (Irsko, irishstatutebook.ie).
  - S.I. 249/2023 Public Health (Alcohol) (Labelling) Regulations 2023.
  - Alcohol (Minimum Pricing) (Scotland) Act 2012 a SSI 2018/135.
  - WHO Europe komentář k irskému labellingu (26. 5. 2023).
  - WHO „Best Buys" Appendix 3 NCD Action Plan (2023 update).
- **Co bylo zachováno bez úprav (ověřeno):**
  - Centrální argumentační struktura (vysoká spotřeba → zdravotní zátěž → osvědčené nástroje → ČR nezavedla).
  - IARC klasifikace alkoholu jako Group 1 karcinogen.
  - Severské monopoly (Systembolaget, Vinmonopolet, Alko, Vínbúðin) — verifikováno.
  - Loi Évin (Francie 1991, TV reklama).
  - Tři politické brzdy (sektorová lobby, rozpočtová úvaha, veřejné mínění).
  - Indikátor `alkohol_spotreba` jako kombinace prodejních statistik a populačních průzkumů (definice z metodické karty).
  - Limitace turistický alkohol + samovýroba destilátů (metodická karta).
- **Zdroje použité k revizi (všechny primární nebo institucionální):**
  - OECD — Health at a Glance 2025, kapitola Alcohol consumption (přímý permalink _f009f222.html).
  - WHO Europe stanovisko 2023 + Anderson et al. Lancet Public Health 2023.
  - IARC Monographs Vol 100E (publications.iarc.fr).
  - Rumgay et al. NEJM 2023.
  - Wagenaar AC, Salois MJ, Komro KA. Addiction 2009 (price elasticity meta-analysis).
  - Wyper GMA et al. Lancet 2023 (Scotland MUP controlled ITS evaluation).
  - Štelemėkas M et al. BMC Medicine 2022 (Lithuania mortality inequalities ITS).
  - Rehm J et al. Addiction 2025 (Lithuania ROI).
  - Public Health (Alcohol) Act 2018, S.I. 249/2023, S.I. 422/2025, S.I. 423/2025 (Irsko, irishstatutebook.ie).
  - Alcohol (Minimum Pricing) (Scotland) Act 2012; SSI 2018/135.
  - Public Health Scotland MUP evaluation portal.
  - WHO GISAH (data.who.int/gho); WHO Global Status Report 2018.
  - WHO „Best Buys" Appendix 3, NCD Global Action Plan update 2023.
  - NZIP — alkohol; SNN ČLS JEP; MF ČR závěrečný účet státního rozpočtu.
- **Otevřené otázky pro ruční rozhodnutí redakce / kandidáti na další iteraci:**
  1. **Rekonciliace `alkohol_spotreba` v `data/indicators.json`** — rozhodnout: (a) ponechat dashboard na WHO GISAH total APC (~14,4) s explicitní metodickou poznámkou, nebo (b) přejít na OECD H@G 2025 (~11,2) jako primární metriku a unrecorded vrstvu modelovat zvlášť. V obou případech aktualizovat článek o závazné metodice. Doporučení: (b), protože OECD je v dashboardu primární benchmark a OECD průměr je 8,5 (ne 8,9 jako v dashboardu).
  2. **Rekonciliace OECD průměru 8,9 → 8,5** — paralelně s bodem 1; benchmark v `data/indicators.json` neodpovídá H@G 2025.
  3. **Aktualizace souvisejících indikátorů** — `mortalita_preventabilni` (155 / 121) a `sebevrazdy_per_100k` (12,5 / 10,5) by si zasloužily samostatnou verifikaci proti OECD H@G 2025. Mimo rámec tohoto auditu.
  4. **Vizuál: trend graf APC ČR 2010–2024 (WHO GISAH vs. OECD recorded)** — kandidát na liniový graf po rekonciliaci datového kontraktu. Pozor: dvě paralelní řady (s rozdílem ~3 l) by měly být explicitně označeny metodikou.
  5. **Vizuál: srovnávací tabulka „Co dělají jiné země"** — Skotsko (MUP 2018), Litva (daň/reklama 2017–2018), Irsko (labelling 2018–2028), Norsko/Švédsko/Finsko/Island (monopoly), Francie (Loi Évin 1991). Kandidát na tabulku v sekci „Co funguje". Po rekonciliaci APC.
  6. **Český case study — daňový výnos a politické pokusy** — sekce „Tři politické brzdy" by si zasloužila domácí časovou osu pokusů o zvýšení spotřební daně (2017 zvýšení daně z piva o 6 %, neúspěšné návrhy ČSSD/Pirátů, role Pivovarů a sdružení vinařů). Kandidát na samostatnou redakční iteraci.
  7. **Cross-link s článkem o kouření a obezitě** — `clanek-koureni.html` byl auditován 2026-05-11, `clanek-bmi-obezita.html` zatím ne. Po dokončení audit obezity vznikne kompletní cluster životního stylu vhodný pro souhrnnou KPI dashboardu.
- **Předtím / potom:** 1 cascade flag APC zavedený (analog KV) · 1 cascade flag KV propsaný · 1 atribuce WHO 20/10g opravena → národní doporučení + WHO 2023 stanovisko · 1 misattribuce Skotsko = daň opravena → MUP není daň · 1 chronologie Litvy upřesněna 2017 → 2017–2018 s detaily · 1 přepočet piva opraven (5 % → 4 %/10° desítka, 350 → 360 L) · 1 paralelní přepočet pro OECD 11,2 doplněn · 1 irský labellingový režim doplněn o S.I. 249/2023 a odsunutí na 3. 9. 2028 · 1 IARC Vol 100E + Rumgay NEJM 2023 doplněno · 1 Wagenaar 2009 elasticity meta-analýza doplněna · 1 Wyper 2023 Lancet MUP evaluace s konkrétními procenty (13,4 % úmrtí, 4,1 % hospitalizací) · 1 Štelemėkas 2022 + Rehm 2025 pro Litvu · 7 generických zdrojových URL nahrazeno 20 stabilními permalinky s DOI ve 4 kategoriích · 1 review-pending banner v hlavičce · 1 audit-disclaimer v sekci Zdroje · 4 interní křížové odkazy (kardiovaskularni-mortalita, koureni, pm25-spinavy-vzduch, mortalita_preventabilni/sebevrazdy přes indikátorové linky) · `articles.json` aktualizován s audit objektem · `meta robots` z `index, follow` na `noindex, follow` + `article:audit-status: review-pending` · 0 textových odstavců smazáno · 0 nových vizuálů (kandidáty zaznamenány v otevřených otázkách, čekají na rekonciliaci APC).
