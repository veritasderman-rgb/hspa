...
const MANIFEST = {
  ...
  'clanek-uhradova-vyhlaska-2027': { kicker: 'Financování · úhrady', signal: 'bad', stat: '88,4', statSuffix: '%', claim: 'poměr dvou sazeb, ze kterých vyhláška počítá úhradu nemocnic.', context: 'V roce 2025 to bylo 95,3 % — vyhláška to sama nazývá „významným zhoršením“.' },
  'clanek-spotreba-antidiabetik': { kicker: 'Léková politika · diabetes', signal: 'warn', stat: '113,1', claim: 'denních dávek antidiabetik na 1 000 obyvatel a den vydá Česko (2025).', context: 'Šesté nejvyšší z 30 zemí OECD. Na pacienta jen 1,36 dávky.' },
  ...
  'clanek-transplantace-darcovstvi-organu': { kicker: 'Transplantace · orgány', signal: 'good', stat: '975', claim: 'transplantovaných orgánů — český rekord roku 2025 (+23 meziročně).', context: '341 zemřelých dárců, 31,3 na milion — Česko v top 10 světa.' },
  ...
  'clanek-kapavka-gonorea': { kicker: 'Prevence · pohlavní nemoci', signal: 'bad', stat: '3 065', claim: 'hlášených případů kapavky za rok 2024 — čtyřnásobek proti roku 2010.', context: '28,1 na 100 tisíc obyvatel, průměr EU/EEA 25,0.' },
  'clanek-prazdna-luzka-efektivita': { kicker: 'Nemocniční péče · kapacita', signal: 'warn', stat: '56', statSuffix: '%', barPct: 56, claim: 'obložnost akutních lůžek — přes 40 % kapacity průměrně stojí.', context: '~18 600 prázdných lůžek denně. Následná jsou plná z 84 %.' },
  'clanek-farmaceuti-pracovni-sila': { kicker: 'Pracovní síla · lékárny', signal: 'warn', stat: '76', claim: 'farmaceutů na 100 tisíc obyvatel — pod průměrem OECD i pod všemi sousedy.', context: 'OECD 86, Rakousko 109, Polsko 92, Německo 84, Slovensko 80.' },
  'clanek-katastroficke-vydaje-zdravi': { kicker: 'Financování · ochrana pacienta', signal: 'bad', stat: '21', statSuffix: '%', barPct: 21, claim: 'nejchudších domácností zažilo v roce 2023 katastrofické výdaje na zdraví.', context: 'V celé populaci 6 % — evropský medián. V roce 2018 to bylo 14 %.' },
  'clanek-zdravotni-gramotnost': { kicker: 'Populace · zdravotní gramotnost', signal: 'warn', stat: '47', statSuffix: '%', barPct: 47, claim: 'dospělých Čechů má omezenou zdravotní gramotnost.', context: 'Zhruba evropský průměr a zlepšení z 59 % v roce 2015 (HLS19, SZÚ).' },
  'clanek-uhlikova-stopa-zdravotnictvi': { kicker: 'Udržitelnost · klima', signal: 'warn', stat: '4,4', statSuffix: '%', barPct: 4, claim: 'světových emisí skleníkových plynů má na svědomí zdravotnictví.', context: 'Jako stát by šlo o pátého největšího znečišťovatele planety.' },
  'clanek-nadeje-doziti-vzdelani': { kicker: 'Populace · nerovnosti', signal: 'bad', stat: '13', claim: 'let života navíc má ve 25 letech vysokoškolák proti vrstevníkovi se základní školou.', context: 'Druhý největší vzdělanostní rozdíl v Evropě — větší propast má jen Maďarsko.' },
  'clanek-preziti-karcinom-plic': { kicker: 'Onkologie · přežití', signal: 'bad', stat: '10,6', statSuffix: '%', barPct: 11, claim: 'pětileté přežití po diagnóze karcinomu plic v Česku.', context: 'Průměr OECD 17,1 %, EU 15,0 %. Hůř je na tom z OECD jen Chile.' },
  'clanek-benzodiazepiny-seniori': { kicker: 'Kvalita péče · senioři', signal: 'bad', stat: '15', statSuffix: '%', barPct: 15, claim: 'lidí nad 65 let bere benzodiazepiny pravidelně.', context: 'Dvaapůlkrát víc než v Německu (~6 %). Roste riziko pádů a zlomenin.' },
  'clanek-preskripce-praktici-2026': { kicker: 'Legislativa · preskripce', signal: 'good', stat: '1 200', claim: 'léků smí od července 2026 předepsat i praktický lékař.', context: 'Vyhláška č. 119/2026 Sb. uvolnila zhruba osminu ambulantních léků.' },
  'clanek-penize-zdravotnictvi-smlouvy-nemocnic': { kicker: 'Financování · Registr smluv', signal: 'neutral', stat: '1,6', claim: 'miliardy korun stála nejdražší smlouva fakultní nemocnice — genová terapie.', context: 'Cystická fibróza za 788 milionů, onkologika za stovky milionů.' },
  ...
  'clanek-tamoxifen-vypadek': { kicker: 'Léková politika · výpadky', signal: 'bad', stat: '1 376', claim: 'aktivních výpadků léčiv eviduje SÚKL — tamoxifen je jeden z nich.', context: 'Lék na rakovinu prsu je přerušený do 15. 7. 2027.' },
  ...
  'clanek-pokusy-o-sebevrazdu-hospitalizace': { kicker: 'Duševní zdraví · sebevraždy', signal: 'bad', stat: '26,6', statSuffix: '%', barPct: 27, claim: 'hospitalizací po pokusu o sebevraždu připadá na teenagery.', context: 'V roce 2014 to bylo 14,3 %. Míra u 15–19 let vzrostla o 90 % proti roku 2020.' },
  'clanek-demence-prevalence': { kicker: 'Veřejné zdraví · demence', signal: 'warn', stat: '135 722', claim: 'lidí se v Česku léčilo pro demenci v roce 2024.', context: 'Od roku 2010 dvojnásobek. Třetina nemocných zůstává mimo dohled.' },
  'clanek-detsti-praktici-starnou': { kicker: 'Pracovní síla · pediatrie', signal: 'bad', stat: '34,6', statSuffix: '%', barPct: 35, claim: 'dětských praktiků je starších 65 let (2023).', context: 'Za pět let zmizelo 336 míst. 182 tisíc dětí bez kapitace.' },
  'clanek-domaci-pece-stagnace': { kicker: 'Dlouhodobá péče · domácí péče', signal: 'warn', stat: '13,63', claim: 'pacienta domácí péče na 1 000 obyvatel (2020) — jako v roce 2007.', context: 'Seniorů mezitím přibylo o polovinu. Stát souhrn nezveřejnil.' },
  'clanek-fyzioterapeuti-rehabilitace': { kicker: 'Pracovní síla · rehabilitace', signal: 'bad', stat: '86', claim: 'fyzioterapeutů na 100 tisíc obyvatel (2023). Průměr EU je 147.', context: '58 % průměru EU. Česko rostlo o 6 %, Evropa o 29 %.' },
  'clanek-medikacni-pochybeni-nemocnice': { kicker: 'Bezpečnost péče · léky', signal: 'warn', stat: '829', claim: 'hlášených pochybení při podávání léků za rok 2023.', context: '0,7 % nežádoucích událostí. OECD: až každá desátá hospitalizace.' },
  'clanek-rehospitalizace-schizofrenie': { kicker: 'Duševní zdraví · schizofrenie', signal: 'bad', stat: '15,6', statSuffix: '%', barPct: 16, claim: 'hospitalizací se schizofrenií se do 30 dnů opakuje (2021).', context: 'Podíl od roku 2017 roste, přestože reforma slibovala opak.' },
  'clanek-platy-sester': { kicker: 'Pracovní síla · sestry', signal: 'neutral', stat: '1,48', statSuffix: '×', claim: 'průměrné mzdy bere nemocniční sestra — víc než průměr OECD (1,2).', context: 'Z vrcholu 1,76 tři roky taje. Sester je 9 na 1 000 obyvatel.' },
  'clanek-asistovana-reprodukce': { kicker: 'Dostupnost · reprodukce', signal: 'neutral', stat: '3 621', claim: 'cyklů asistované reprodukce na milion obyvatel (2019) — nejvíc v Evropě.', context: 'Evropský průměr 1 581. ESHRE, jen země s úplným reportingem.' },
