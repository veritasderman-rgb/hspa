...
const MANIFEST = {
  ...
  'clanek-detsti-praktici-starnou': { kicker: 'Pracovní síla · pediatrie', signal: 'bad', stat: '34,6', statSuffix: '%', barPct: 35, claim: 'dětských praktiků je starších 65 let.', context: 'Za pět let zmizelo 336 míst. 182 tisíc dětí bez kapitace.' },
  'clanek-domaci-pece-stagnace': { kicker: 'Dlouhodobá péče · domácí péče', signal: 'warn', stat: '13,63', claim: 'pacienta domácí péče na 1 000 obyvatel — stejně jako v roce 2007.', context: 'Seniorů mezitím přibylo o polovinu. Stát souhrn nezveřejnil.' },
  'clanek-fyzioterapeuti-rehabilitace': { kicker: 'Pracovní síla · rehabilitace', signal: 'bad', stat: '86', claim: 'fyzioterapeutů na 100 tisíc obyvatel. Průměr EU je 147.', context: '58 % průměru EU. Česko rostlo o 6 %, Evropa o 29 %.' },
  ...
  'clanek-rehospitalizace-schizofrenie': { kicker: 'Duševní zdraví · schizofrenie', signal: 'bad', stat: '15,6', statSuffix: '%', barPct: 16, claim: 'hospitalizací se schizofrenií se do 30 dnů opakuje.', context: 'Podíl od roku 2017 roste, přestože reforma slibovala opak.' },
  ...
  'clanek-asistovana-reprodukce': { kicker: 'Dostupnost · reprodukce', signal: 'neutral', stat: '3 621', claim: 'cyklů asistované reprodukce na milion obyvatel — nejvíc v Evropě.', context: 'Evropský průměr je 1 581 cyklů. Zdroj: monitoring ESHRE.' },
