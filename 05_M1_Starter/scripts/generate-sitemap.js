...
export const STATIC_PAGES = [
  ...
  { loc: '/plneni-onko-2030.html', priority: '0.7', changefreq: 'monthly' },
  { loc: '/plneni-kv-2035.html', priority: '0.7', changefreq: 'monthly' },
  { loc: '/plneni-amr.html', priority: '0.7', changefreq: 'monthly' },
  { loc: '/plneni-dusevni-zdravi.html', priority: '0.7', changefreq: 'monthly' },
  { loc: '/plneni-zdravi-2030.html', priority: '0.7', changefreq: 'monthly' },
  { loc: '/plneni-socialni-sluzby.html', priority: '0.7', changefreq: 'monthly' },
  { loc: '/plneni-socialni-sluzby-2016-2025.html', priority: '0.6', changefreq: 'monthly' },
