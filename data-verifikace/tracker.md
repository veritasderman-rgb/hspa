...
> (soubor NENÍ v repu veritasderman-rgb/hspa — produkce je před repozitářem). Cache: `nzip-cache/portal-dohodovaci-rizeni.json`.
>
> Generováno 2026-05-22. Verifikace je READ-ONLY.

Stav: **0 / 44 PASS** · TODO 44 · PASS 0 · FAIL 0 · BLOCKED 0

| # | id | dimenze | status | hodnota_portal | hodnota_nzip | nzip_url | list+buňka | poznámka |
|---|---|---|---|---|---|---|---|---|
| 1 | nr-02-01 | d9 Doplňkové registry a otevřená data | TODO | 210340 úvazků (2024) |  |  |  |  |
