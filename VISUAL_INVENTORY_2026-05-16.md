...
### G) Klinický / onkologie a screening (8 článků)
...
### H) Digitalizace / eHealth / AI (7 článků)
...
### K) Outcomes / mortalita / nárok (8 článků)
**Slugy:** `nadeje-doziti-zdravi`, `pyll`, `kardiovaskularni-mortalita`, `sebevrazdy-dusevni-zdravi`, `vyhnutelne-hospitalizace`, `hospitalizujeme-nejvic`, `ambulantni-kontakty`, `cekani-specialista`, `cekaci-doby-kycel`, série `narok-pojistence-1/2/3`.
...
### L) Ostatní (HTA, transplantace, manifest, IP zdraví, strategický rámec) (8 článků)
